...
# Stub dawdreamer before importing the module so the module-level import doesn't fail
sys.modules.setdefault("dawdreamer", MagicMock())

from mimic_synth.s01_capture.capture_v1_2 import (  # noqa: E402
    apply_params,
    sample_vectors,
    resolve_plugin_path,
    load_profile,
...
import mimic_synth.s01_capture.capture_v1_2 as capture_v1_2
from mimic_synth.config import PROFILE_PATH as _DEFAULT_PROFILE
