...
from mimic_synth.s06_refine.target_analysis import (
    TargetAnalysis,
    analyze_target,
    suggest_x0,
    _attack_ms_to_param,
...
class TestMRSTFTDist:
    ...
    def setup_method(self):
        from mimic_synth.s06_refine.audio_compare import _mrstft_dist
...
class TestLUFSNormalise:
    ...
    def setup_method(self):
        from mimic_synth.s06_refine.audio_compare import _lufs_normalize
...
class TestFilterCutoffTrajectory:
    ...
    def setup_method(self):
        from mimic_synth.s05_invert.stream_invert import (
...
class TestSmoke:
    def test_modules_importable(self):
        from mimic_synth.s06_refine import mono_utils, target_analysis, vst_hill_climb, vst_cmaes
    ...
    def test_analyze_crane_scream_if_available(self):
        ...
        import soundfile as sf
        from mimic_synth.s06_refine.target_analysis import print_analysis
        target = Path(
